...
#ifndef METASPACE_COMMITTED_BITMAP_HPP
#define METASPACE_COMMITTED_BITMAP_HPP
...
namespace metaspace {
     ...
     * 0 表示未提交
     */
    class CommittedBitMap : public CHeapBitMap {
    private:
        /**
        ...
        */
        inline static size_t statistics_bytes_per_bit() {
            return metaspace::Setting::CommitGranuleBytes;
        };
    ...
    public:
        ...
        [[nodiscard]] inline size_t mapping_range_bytes() const {
            return this->total_bits() * CommittedBitMap::statistics_bytes_per_bit();
        };
...
#endif //METASPACE_COMMITTED_BITMAP_HPP
